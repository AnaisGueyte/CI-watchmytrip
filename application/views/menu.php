    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li ><a href="#" id="red"><span class="badge badge-info pull-left">4</span>Khadija<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-user" id="red"></span></a></li>
        </ul>
      </div>
    </div>
  </nav>
