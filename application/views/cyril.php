            ...
            <div class="row">
                ...
                <div class="col-xs-10">
                        ...
                        <script  type="text/javascript" >
                            map = L.map('map').setView([48.8582, 2.3387], 3);
                            tuileUrl = 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
                            attrib='Map data © <a href="http://openstreetmap.org">OpenStreetMap</a> contributors';

                            osm = new L.TileLayer(tuileUrl, {minZoom: 3, maxZoom: 18, attribution: attrib});

                            map.addLayer(osm);

                            marker = L.marker([48.8582, 2.3387]).addTo(map).bindPopup("<b>Popup n°1</b>");  
                           
                      
                        </script>

<div id="markerActive" style="display:none">
