                    ...
                    <nav class="navbar navbar-inverse sidebar" role="navigation">
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <input type="button" class="btn btn-lg btn-primary launch-modal" value="Afficher le dialogue">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p> Voulez-vous sauvegarder les changements avant fermuture?</p>
                                                <p class="text-warning"><small>Autrement, ils seront perdus!</small></p>
                                            </div>
