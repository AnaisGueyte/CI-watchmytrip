                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="azerty">
                                <ul class="nav navbar-nav">
                                    <li class="active" id="red"><a href="#" id="red">Anaïs<span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-user" id="red"></span></a></li>
                                    <li ><a href="#" id="red">Audric<span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-user" id="red"></span></a></li>
                                    <li ><a href="#" id="red">Benjamin<span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-user" id="red"></span></a></li>
                                    <li ><a href="#" id="red">Cyril<span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-user" id="red"></span></a></li>
